...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide letter-spacing-0.05em',
  {
    variants: {
      variant: {
        ...
        outline: 'border-2 border-foreground hover:bg-foreground hover:text-background bg-transparent',
